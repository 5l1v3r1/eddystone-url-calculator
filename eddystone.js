...
var Command = function (_Component) {
   ...
   function Command(props) {
      ...
      return _possibleConstructorReturn(this, Object.getPrototypeOf(Command).call(this, props));
   }
   ...
   _createClass(Command, [{
      ...
      value: function render() {
         ...
         var retcomp = _react2.default.createElement("div", null);
         if (processedUrl.length === 0) {
            commandstring = "Enter a URL above.";

            retcomp = _react2.default.createElement(
               "div",
...
var Explore = function (_Component) {
  ...
  function Explore(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Explore).call(this, props));
  ...
  _createClass(Explore, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { type: 'text', value: this.state.url, placeholder: 'http://webgazer.org', onKeyDown: this.handleSubmit, onChange: this.handleChange })
      );
    }
  }]);
...
var Main = function (_Component) {
  ...
  _createClass(Main, [{
    ...
    value: function handleDismissClick(e) {
      this.props.resetErrorMessage();
      e.preventDefault();
    }
  }, {
    key: 'processUrl',
    value: function processUrl(nextVal) {
      this.setState({
        url: nextVal
      });
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Explore2.default, { process: this.processUrl }),
        _react2.default.createElement('hr', null),
        this.renderErrorMessage(),
        _react2.default.createElement(_Command2.default, { url: this.state.url })
      );
    }
  }]);
...
},{"./Command":159,"./Explore":160,"react":158}],162:[function(require,module,exports){
'use strict';
...
},{"./containers/Main":161,"react":158,"react-dom":2}]},{},[162]);
